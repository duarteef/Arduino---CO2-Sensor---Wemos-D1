 ...
 * Para usar do sensor de CO2 (MHZ19B), chamamos a atenção para as conexões com os cabos de energia e de comunicação com o Controlador e recomendamos ler informações disponiveis em:
